package org.server.localshop.core.domain;

public class BonWaysTenant {
    ...
    public BonWaysTenant(final Long id, final String tenantIdentifier, final String name, final String schemaName,
